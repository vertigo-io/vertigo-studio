 ...
 * @author dchallas
 */
public class DtDefinitionsGeneratorTest extends AbstractTestCaseJU5 {
	...
	public void testGenerate() {
		...
		mdaProperties.put("vertigo.domain.java.dictionaryClassName", "MyDtDefinitions");

		mdaManager.generate(studioMetamodelManager.parseResources(resources),
				MdaConfig.of("target/", "io.vertigo.studio", mdaProperties));
	}
