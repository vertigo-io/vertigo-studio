...
public class ShinyProgressBarTest {
	...
	private static void testBasicProgressBar() {
		System.out.println(ShinyColors.BLUE_BRIGHT + "--- Basic Progress Bar ---" + ShinyColors.RESET);
	...
	private static void testSlowProgressBar() {
		System.out.println(ShinyColors.BLUE_BRIGHT + "--- Slow Progress Bar ---" + ShinyColors.RESET);
	...
	private static void testMultipleProgressBars() {
		System.out.println(ShinyColors.BLUE_BRIGHT + "--- Multiple Progress Bars (Sequential) ---" + ShinyColors.RESET);
		for (int j = 0; j < 3; j++) {
