...
public class ShinyInputTextTest {
	...
	private static void testBasicInput() {
		...
		ShinyInputText inputText = Shiny.inputText().label("Enter your name");
		inputText.print();
	...
	private static void testRequiredInput() {
		...
		ShinyInputText inputText = Shiny.inputText().label("Enter a value").required(true);
		inputText.print();
		System.out.println("You entered: " + inputText.getValue());
		waitForEnter();
	}
	...
	private static void testPatternValidation() {
		...
		ShinyInputText inputText = Shiny.inputText().label("Enter 5 lowercase letters").pattern("[a-z]{5}");
		inputText.print();
		System.out.println("You entered: " + inputText.getValue());
		waitForEnter();
	}
	...
	private static void testDefaultValue() {
		...
		ShinyInputText inputText = Shiny.inputText().label("Enter your age").defaultValue("30");
		inputText.print();
		System.out.println("You entered: " + inputText.getValue());
		waitForEnter();
	}
	...
	private static void testSuggestions() {
		...
		ShinyInputText inputText = Shiny.inputText().label("Choose your favorite color").suggestions(List.of("red", "green", "blue"));
		inputText.print();
		System.out.println("You entered: " + inputText.getValue());
		waitForEnter();
	}
	...
	private static void testSecretInput() {
		...
		ShinyInputText inputText = Shiny.inputText().label("Enter your password").secret(true);
		inputText.print();
		System.out.println("You entered: " + inputText.getValue());
		waitForEnter();
	}
