...
public class ShinyJsonTest {
	...
	private static void testBasicJson() {
		System.out.println(ShinyColors.BLUE_BRIGHT + "--- Basic JSON ---" + ShinyColors.RESET);
	...
	private static void testComplexJson() {
		System.out.println(ShinyColors.BLUE_BRIGHT + "--- Complex JSON ---" + ShinyColors.RESET);
		final String json = """
							{
							  "product": {
							    "id": 123,
	...
	private static void testCustomColorsJson() {
		System.out.println(ShinyColors.BLUE_BRIGHT + "--- Custom Colors JSON ---" + ShinyColors.RESET);
		final String json = """
				{
	...
	private static void testGranularColorsJson() {
		System.out.println(ShinyColors.BLUE_BRIGHT + "--- Granular Colors JSON ---" + ShinyColors.RESET);
	...
	private static void testErrorJson() {
		System.out.println(ShinyColors.BLUE_BRIGHT + "--- Error JSON ---" + ShinyColors.RESET);
