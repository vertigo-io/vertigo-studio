...
public class ShinySparklineTest {
	...
	private static void testTemperatureSparkline() {
		System.out.println(ShinyColors.BLUE.bright() + "--- Temperature Sparkline ---" + ShinyColors.RESET);
		Shiny.sparkline()
				.title("Temperature")
	...
	private static void testStockPriceSparkline() {
		System.out.println(ShinyColors.BLUE.bright() + "--- Stock Price Sparkline ---" + ShinyColors.RESET);
		Shiny.sparkline()
				.title("Stock Price")
	...
	private static void testCPULoadSparkline() {
		System.out.println(ShinyColors.BLUE.bright() + "--- CPU Load Sparkline ---" + ShinyColors.RESET);
		Shiny.sparkline()
				.title("CPU Load")
	...
	private static void testConstantValueSparkline() {
		System.out.println(ShinyColors.BLUE.bright() + "--- Constant Value Sparkline ---" + ShinyColors.RESET);
		Shiny.sparkline()
				.title("Constant")
	...
	private static void testEmptyDataSparkline() {
		System.out.println(ShinyColors.BLUE.bright() + "--- Empty Data Sparkline ---" + ShinyColors.RESET);
		Shiny.sparkline()
				.title("Empty")
