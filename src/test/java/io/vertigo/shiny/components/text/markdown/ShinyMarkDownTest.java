...
public class ShinyMarkDownTest {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        Shiny.markdown().withText("# Title 1").render(writer);
        System.out.println("--- Testing List ---");
        Shiny.markdown().withText("* item 1\n* item 2").render(writer);
        System.out.println("--- Testing Table ---");
        Shiny.markdown().withText("| h1 | h2 |\n|---|---|\n| c1 | c2 |").render(writer);
        System.out.println("--- Testing Paragraph ---");
        Shiny.markdown().withText("This is a paragraph.").render(writer);
    }
}
