...
public final class ShinyInputTextRenderer {

	private ShinyInputTextRenderer() {
		//private constructor
	}

	public static void render(final ShinyInputText shinyInputText, final ShinyWriter writer) {
