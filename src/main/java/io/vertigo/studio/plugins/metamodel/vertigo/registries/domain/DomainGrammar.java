 ...
 */
package io.vertigo.studio.plugins.metamodel.vertigo.registries.domain;

import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.ARGS;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.CARDINALITY;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.CLASS_NAME;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.DATA_SPACE;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.DISPLAY_FIELD;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.EXPRESSION;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.FK_FIELD_NAME;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.FRAGMENT_OF;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.HANDLE_FIELD;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.INDEX_TYPE;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.LABEL;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.LABEL_A;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.LABEL_B;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.MAX_LENGTH;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.MSG;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.MULTIPLICITY_A;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.MULTIPLICITY_B;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.NAVIGABILITY_A;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.NAVIGABILITY_B;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.PERSISTENT;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.ROLE_A;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.ROLE_B;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.SORT_FIELD;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.STEREOTYPE;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.STORE_TYPE;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.TABLE_NAME;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.TYPE;
import static io.vertigo.studio.plugins.metamodel.vertigo.KspProperty.UNIT;
import static io.vertigo.studio.plugins.metamodel.vertigo.dsl.entity.DslPropertyType.Boolean;
import static io.vertigo.studio.plugins.metamodel.vertigo.dsl.entity.DslPropertyType.Integer;
import static io.vertigo.studio.plugins.metamodel.vertigo.dsl.entity.DslPropertyType.String;
