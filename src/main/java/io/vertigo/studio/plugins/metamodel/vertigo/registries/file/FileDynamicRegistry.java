 ...
 */
package io.vertigo.studio.plugins.metamodel.vertigo.registries.file;
...
public final class FileDynamicRegistry implements DynamicRegistry {
	...
	private static StudioFileInfo createFileDefinition(final DslDefinition xFileDefinition) {
		...
		return new StudioFileInfo(fileDefinitionName, storeName);
	}
