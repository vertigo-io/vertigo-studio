 ...
 */
@DefinitionPrefix(FormatterSketch.PREFIX)
public final class FormatterSketch extends AbstractSketch {
	...
	*/
	 ...
	 */
	public FormatterSketch(final String name, final String formatterClassName, final String args) {
		super(name);
		//---
