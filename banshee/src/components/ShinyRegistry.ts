import VShinyBoardComponent from './data/board/v-shiny-board.vue';
import VShinyContainerComponent from './block/v-shiny-container.vue';
import VShinyErrorComponent from './feedback/v-shiny-error.vue';
import VShinyCardComponent from './data/v-shiny-card.vue';
import VShinyChipComponent from './text/v-shiny-chip.vue';
import VShinyFormComponent from './input/form/v-shiny-form.vue';
import VShinyNotificationComponent from './feedback/v-shiny-notification.vue';
import VShinyModalComponent from './feedback/v-shiny-modal.vue';
import VShinyJsonComponent from './data/v-shiny-json.vue';
import VShinyListComponent from './data/v-shiny-list.vue';
import VShinyOrganizationComponent from './dataviz/v-shiny-organization.vue';
import VShinyTableComponent from './data/v-shiny-table.vue';
import VShinyTimelineComponent from './dataviz/v-shiny-timeline.vue';
import VShinyTreeComponent from './data/v-shiny-tree.vue';
import VShinyDataGridComponent from './data/v-shiny-datagrid.vue';
import VShinyAreaChartComponent from './dataviz/v-shiny-area-chart.vue';
import VShinyBarChartComponent from './dataviz/v-shiny-bar-chart.vue';
import VShinyDonutChartComponent from './dataviz/v-shiny-donut-chart.vue';
import VShinyGeoMapComponent from './dataviz/v-shiny-geo-map.vue';
import VShinyLineChartComponent from './dataviz/v-shiny-line-chart.vue';
import VShinyMindMapComponent from './dataviz/v-shiny-mindmap.vue';
import VShinyPieChartComponent from './dataviz/v-shiny-pie-chart.vue';
import VShinyRadarChartComponent from './dataviz/v-shiny-radar-chart.vue';
import VShinyRatingComponent from './text/v-shiny-rating.vue';
import VShinySankeyComponent from './dataviz/v-shiny-sankey.vue';
import VShinySparkLineComponent from './text/v-shiny-spark-line.vue';
import VShinyStatusComponent from './text/v-shiny-status.vue';
import VShinyFlowComponent from './dataviz/v-shiny-flow.vue';
import VShinyAlertComponent from './feedback/v-shiny-alert.vue';
import VShinySliderComponent from './input/form/v-shiny-slider.vue';
import VShinyMultiSelectionComponent from './input/multiselection/v-shiny-multiselection.vue';
import VShinyInputTextComponent from './input/text/v-shiny-inputtext.vue';
import VShinyProgressBarComponent from './live/v-shiny-progress-bar.vue';
